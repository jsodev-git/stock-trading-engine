...
국내 주식 거래 비용 구조 (2026년 기준):
- 증권사 수수료 (매수/매도 양쪽): KIS 온라인 비우대 0.015% 가정
- 증권거래세 (매도 시만, 시장별 차등)
  - KOSPI: 증권거래세 0% + 농어촌특별세 0.15% = 0.15%
  - KOSDAQ: 증권거래세 0.15% = 0.15%
- 모의투자는 수수료·세금 없음 (KIS 모의 규정)
...
_SCHEDULES: dict[tuple[str, str], FeeSchedule] = {
    ...
    # 실계좌 — KIS 온라인 비우대 수수료 0.015%, 2026년 거래세 개편 반영 (모두 0.15%)
    ("REAL", "KOSPI"): FeeSchedule(0.00015, 0.00015, 0.0015),
    ("REAL", "KOSDAQ"): FeeSchedule(0.00015, 0.00015, 0.0015),
}
